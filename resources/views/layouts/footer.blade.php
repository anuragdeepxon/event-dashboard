...
<footer class="footer footer-center p-10 bg-neutral text-base-content rounded">
    ...
    <div>
        <p>Copyright &copy;2022<a class="text-black-500 font-bold link link-hover"> Events </a> | Developed by <a class="text-black-500 font-bold link link-hover hover:text-white" href="https://anuragdeep.com">Anurag Deep</a></p>
    </div>
</footer>
<!-- /footer -->
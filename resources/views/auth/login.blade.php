                    ...
                    <div class="md:p-12 md:mx-6">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="text-center pt-1 mb-12 pb-1">
                                ...
                                <a style="color:black !important" class="text-slate-900" href="{{ route('password.request') }}">
                            ...
                            <div class="flex items-center justify-between pb-6">
                                ...
                                <a style="color:black !important" href="{{ route('register') }}" class="text-slate-900 inline-block px-6 py-2 border-2 border-blue-600  font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light">
                                    Create Account
                                </a>
                            </div>
                        </form>

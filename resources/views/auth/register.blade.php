                ...
                <div class="lg:w-6/12 px-4 md:px-0">
                    <div class="md:p-12 md:mx-6">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-4">
                                <input placeholder="Enter Name" id="name" type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                @error('name')
                            ...
                            <div class="flex items-center justify-between pb-6">
                                ...
                                <a style="color:black !important" href="{{ route('login') }}" class="text-slate-700 inline-block px-6 py-2 border-2 border-blue-600  font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light">
                                    Login
                                </a>
                            </div>
                        </form>
